...
<html lang="en">
  ...
  <body>
    ...
    <div class="card mx-auto my-3" style="max-width: 80rem;">
        ...
        <div class="body-header text-white bg-primary list-group">
            <a href="{{url('/company')}}" class="list-group-item list-group-item-action">Company</a>
            <a href="{{url('/employee')}}" class="list-group-item list-group-item-action">Employee</a>
            <a href="{{url('/role')}}" class="list-group-item list-group-item-action">Role</a>
        </div>
