		...
		<div class="card-body">
			...
			<div class="form">
				...
				<div class="form-row align-items-end my-3">
					<div class="col-3">
						<input value="{{request('keyword1')}}" class="form-control" type="text" name="keyword1" placeholder="- Select Company Code -">
					</div>
					<div class="col-3">
						<input value="{{request('keyword2')}}" class="form-control" type="text" name="keyword2" placeholder="- Select Company Name -">
					</div>
					<div class="col">
						<input value="{{request('keyword3')}}" class="form-control" id="date" type="text" name="keyword3" placeholder="Created">
					</div>
					<div class="col">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$comp->code}}</td>
						<td>{{$comp->name}}</td>
						<td>{{\Carbon\Carbon::parse($comp->created_date)->format('Y/m/d')}}</td>
